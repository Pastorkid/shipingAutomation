...
// Temporarily disabled charts due to import issues
// import {
//   Chart as ChartJS,
//   CategoryScale,
//   LinearScale,
...
import { useLogOutStore } from '../store/auth/logOut/logOutStore';

// Chart.js registration temporarily disabled
// ChartJS.register(
//   CategoryScale,
//   LinearScale,
//   PointElement,
                ...
                {allCharts.slice(0, visibleCharts).map((chart, index) => (
                  ...
                  >
                    ...
                    <div className="h-40 sm:h-48 lg:h-64">
                      {/* Chart placeholder - Chart.js temporarily disabled */}
                      <div className="h-40 sm:h-48 lg:h-64 flex items-center justify-center bg-gray-50 rounded-lg">
