          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-sm sm:text-base">{t.secureAuthentication}</h3>
                <p className="text-xs sm:text-sm opacity-75">{t.secureAuthenticationDesc}</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-sm sm:text-base">{t.realTimeAnalytics}</h3>
                <p className="text-xs sm:text-sm opacity-75">{t.realTimeAnalyticsDesc}</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-sm sm:text-base">{t.globalReach}</h3>
                <p className="text-xs sm:text-sm opacity-75">{t.globalReachDesc}</p>
              </div>
            </div>
          </motion.div>
        </div>
