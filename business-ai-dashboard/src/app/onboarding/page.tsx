            ...
            {onboardingState.setupMethod === 'connect' ? (
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Traditional setup with business information and preferences.
                </p>
                <div className="p-6 bg-gray-50 rounded-xl text-center">
                  <p className="text-sm text-gray-600">
                    Manual setup form would go here...
                  </p>
                </div>
              </div>
            )}
        ...
        return (
          ...
          >
            <EnhancedSetupComplete
              ...
              onActivateAutomation={(automationId) => {
        ...
        <div className="bg-white rounded-xl shadow-lg p-8" style={{ backgroundColor: 'var(--surface)' }}>
          ...
          <div className="flex justify-between items-center mt-12 pt-8 border-t border-gray-100">
            ...
            >
              ...
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-400/20 to-purple-400/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl" />
